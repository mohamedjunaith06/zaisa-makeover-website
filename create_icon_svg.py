icon_svg = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 160" width="100%" height="100%">
  <defs>
  ...
  <g transform="translate(30, 8) scale(0.9)" fill="url(#goldIconGrad)">
...
with open('static/logo-icon.svg', 'w', encoding='utf-8') as f:
    f.write(icon_svg)

print("Created static/logo-icon.svg")
